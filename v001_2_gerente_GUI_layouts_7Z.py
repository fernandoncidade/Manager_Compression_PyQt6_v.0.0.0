...
from v001_4_motores_compressao_7Z import (buscar_sevenzip_executavel, CompressaoZIP, Compressao7Z, CompressaoTAR, TesteIntegridade, Extracao)
# Importa as funções apply_dialog_box_theme, apply_message_box_theme do módulo Colors
from v001_5_colors import apply_dialog_box_theme, apply_message_box_theme
