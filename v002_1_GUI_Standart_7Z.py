...
from v002_2_gerente_GUI_layouts_7Z import GerenciadorInterface
from v002_3_metodos_compressao_7Z import MetodoCompressao
...
class InterfaceGrafica(QMainWindow, MetodoCompressao):
    ...
    def create_method_checkboxes(self, layout):
        ...
        methods = ['zip', '7z', 'tar.bz2', 'zipx', 'tar.xz', 'tgz', 'tar.gz', 'lzh', 'iso', 'tar', 'wim', 'extração']
        self.checkboxes = {}
